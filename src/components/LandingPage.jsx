...
export default function Landing({ onLoginSuccess, onChangeSession, showToast}) {
    ...
    //     e.preventDefault();
    //     if (!user.name || !user.email || !user.employeeId || !user.department || !user.role || !user.city) {
    //         alert('Please fill in all enrollment fields.');
    //         showToast('Please update your information. Name, Email, department, role and Employee ID are required.');
    //         return;
    //     }
    //     const updated = {
    //         ...userSession,
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        <button
                            ...
                            className="w-full bg-[#800000] text-white rounded-lg p-3"
                        >
                            Continue Training
                        </button>
                    </>
